export const profile = {
  ...
  skills: {
    ...
    "AI / ML": ["Anthropic Claude", "OpenAI API", "VADER", "Whisper", "RAG", "Prompt eng."],
    Frontend: ["React", "React Native", "Next.js", "Expo", "Tailwind", "Recharts"],
    Backend: ["FastAPI", "Node.js", "Supabase", "PostgreSQL", "BullMQ", "Redis"],
    "Security & Tooling": [
  ...
  nowBuilding: [
    ...
    "Growing CloutAI and experimenting with AI-driven growth loops.",
